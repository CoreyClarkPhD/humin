...
function CreateEngineJS(){ console.log(Module.testFunc()); this.simulationEngine = new Module.SimEngine(); this.simulationEngine.RegisterSelfAsGlobalSimEngine(); }
